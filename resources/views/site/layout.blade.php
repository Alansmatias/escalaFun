...
<head>
    ...
    <title>Escala Pão da Vida</title>
    <!-- Bootstrap CSS -->
...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none"><!-- Bootstrap Icons -->
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark menuesconde" style="width: 280px;" id="menu-principal">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
          ...
          <div class="collapse" id="periodoSelectorCollapse">
              <div class="list-group ps-3">
                  ...
                  <div>
                      <a class="list-group-item list-group-item-action text-white bg-dark border-0" href="{{ route('periodo.create') }}">
      ...
      <li>
        ...
        <div class="collapse" id="collapseEscala">
          <div class="list-group ps-3">
              <a class="list-group-item list-group-item-action text-white bg-dark border-0" href="{{ route('escala') }}">
          ...
          <div class="list-group ps-3">
              <a class="list-group-item list-group-item-action text-white bg-dark border-0" href="{{route('escalarfun')}}">
      ...
      <li>
        <a class="nav-link text-white" data-bs-toggle="collapse" href="#collapseCadastro" role="button" aria-expanded="false" aria-controls="collapseExample">
        ...
        <div class="collapse" id="collapseCadastro">
          <div class="list-group ps-3">
              <a class="list-group-item list-group-item-action text-white bg-dark border-0" href="{{ route('home.lista.funcionario') }}">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus me-2" viewBox="0 0 16 16">
              <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
              <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5"/>
              </svg>
          ...
          <div class="list-group ps-3">
              <a class="list-group-item list-group-item-action text-white bg-dark border-0" href="{{route('home.lista.setor')}}">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-crosshair me-2" viewBox="0 0 16 16">
              <path d="M8.5.5a.5.5 0 0 0-1 0v.518A7 7 0 0 0 1.018 7.5H.5a.5.5 0 0 0 0 1h.518A7 7 0 0 0 7.5 14.982v.518a.5.5 0 0 0 1 0v-.518A7 7 0 0 0 14.982 8.5h.518a.5.5 0 0 0 0-1h-.518A7 7 0 0 0 8.5 1.018zm-6.48 7A6 6 0 0 1 7.5 2.02v.48a.5.5 0 0 0 1 0v-.48a6 6 0 0 1 5.48 5.48h-.48a.5.5 0 0 0 0 1h.48a6 6 0 0 1-5.48 5.48v-.48a.5.5 0 0 0-1 0v.48A6 6 0 0 1 2.02 8.5h.48a.5.5 0 0 0 0-1zM8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4"/>
              </svg>
              Setor
          ...
          <div class="list-group ps-3">
              <a class="list-group-item list-group-item-action text-white bg-dark border-0" href="{{route('home.lista.turno')}}">
...
<script>
  ...
  menu.classList.toggle("menuesconde"); // Remove a classe que esconde o menu
});
</script>
